...
const PROJECTS = [
  {
    ...
    description:
      'Currently working on it to make is a full-stack platform with proper backend integration like auth,login etc ',
  ...
  },
  {
    ...
    description:
      ' Right now its only frontend is made backend is in process',
    tags: ['React', 'Java', 'SpringBoot'],
    color: '#ff2d78',
    accentColor: '#ff9900',
    gradient: 'linear-gradient(135deg, #1a0410 0%, #2d0820 50%, #1a0410 100%)',
    liveUrl: 'https://gokyorestro.vercel.app/',
  ...
  },
  {
    id: 3,
    title: 'Over 7 Under',
    subtitle: 'A web game about guessing higher / lower',
    description:
    ...
    liveUrl: 'https://over7under.sohangrg.me',
  ...
  },
  {
    id: 4,
    title: 'Yazhtee',
    subtitle: 'A game of Yazhtee',
    description:
      'Browser-based web game for two player',
    tags: ['React', 'Js', 'Css', 'Html'],
    color: '#ffd700',
    accentColor: '#ff2d78',
    gradient: 'linear-gradient(135deg, #1a1400 0%, #2d2000 50%, #1a1400 100%)',
    liveUrl: 'https://yahtzee.sohangrg.me/',
    githubUrl: 'https://github.com/SohanGurung0/Yazti_diceGame',
    stats: { stars: '1', forks: '0', commits: '2' },
    featured: true,
  },
  {
    id: 5,
    title: 'Paw Furr Ever',
    subtitle: 'A ecommerce website for pets',
    description:
      'Paw Furr-Ever is a feature-rich, production-ready Java/J2EE web application built for a pet supply store.',
    tags: ['Java', 'Jarkata EE', 'Tomcat', 'Mysql', 'Maven'],
    color: '#00d4ff',
    accentColor: '#7c3aed',
    gradient: 'linear-gradient(135deg, #020c1b 0%, #0a1628 50%, #071020 100%)',
    liveUrl: 'None',
    githubUrl: 'https://github.com/SohanGurung0/pet-shop',
    stats: { stars: '4', forks: '5', commits: '29' },
    featured: true,
  }/*,
  {
    id: 5,
